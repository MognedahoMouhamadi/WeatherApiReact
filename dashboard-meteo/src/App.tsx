...
export default function App() {
  ...
  useEffect(() => { load("Paris"); }, []); // valeur par défaut

  return (
    <div className="min-h-screen flex flex-col items-center gap-6 bg-gradient-to-r from-blue-400 to-blue-600 p-6">
      <CitySearch value={city} onChange={setCity} onSubmit={() => load(city)} />
